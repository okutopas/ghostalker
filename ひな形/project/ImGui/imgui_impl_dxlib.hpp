...
inline int GetUseDxLibDirect3DVersion() {
...
inline bool ImGui_ImplDXlib_Init() {
...
inline void ImGui_ImplDXlib_NewFrame() {
    switch (GetUseDxLibDirect3DVersion()) {
...
inline void ImGui_ImplDXlib_RenderDrawData() {
    switch (GetUseDxLibDirect3DVersion()) {
...
inline void ImGui_ImplDXlib_Shutdown() {
    switch (GetUseDxLibDirect3DVersion()) {
